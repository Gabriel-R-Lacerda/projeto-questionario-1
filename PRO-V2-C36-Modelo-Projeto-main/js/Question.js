class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta:- o que anda de quatro no inicio, de duas no meio e de três no final " );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("1: um leão " );
    this.option1.position(150, 100);
    this.option2.html("2: um pato" );
    this.option2.position(150, 120);
    this.option3.html("3: uma lontra" );
    this.option3.position(150, 140);
    this.option4.html("4: um humano" );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Obrigado, Sua Resposta Foi Enviada. <br> resposta - O humano, motivo: <br> engatinha quando bebê, anda quado aduldo <br> e na maior idade usa bengala ");
       this.message.position(380, 250);
